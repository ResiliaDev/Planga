...
var _ResiliaDev$planga_chat_client$Models$uniqueMessagesContainerId = function (model) {
	return A2(_elm_lang$core$Basics_ops['++'], 'planga--chat-messages/', model.encrypted_options);
};
var _ResiliaDev$planga_chat_client$Models$filledSocketLocation = F3(
	function (socket_location, public_api_id, encrypted_options) {
		var encoded_encrypted_options = _truqu$elm_base64$Base64$encode(encrypted_options);
		var encoded_public_api_id = _truqu$elm_base64$Base64$encode(public_api_id);
		return A2(
			_elm_lang$core$Basics_ops['++'],
			socket_location,
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					encoded_public_api_id,
					A2(_elm_lang$core$Basics_ops['++'], '&config=', encoded_encrypted_options))));
	});
var _ResiliaDev$planga_chat_client$Models$channelName = F2(
	function (public_api_id, encrypted_options) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'encrypted_chat:',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_truqu$elm_base64$Base64$encode(public_api_id),
				A2(
					_elm_lang$core$Basics_ops['++'],
					'#',
					_truqu$elm_base64$Base64$encode(encrypted_options))));
	});
var _ResiliaDev$planga_chat_client$Models$initialModel = F4(
	function (public_api_id, encrypted_options, socket_location, debug_mode) {
		var filled_socket_location = A3(_ResiliaDev$planga_chat_client$Models$filledSocketLocation, socket_location, public_api_id, encrypted_options);
		var channel_name = A2(_ResiliaDev$planga_chat_client$Models$channelName, public_api_id, encrypted_options);
		return {
			current_time: 0,
			messages: _elm_lang$core$Dict$empty,
			oldest_timestamp: _elm_lang$core$Maybe$Nothing,
			draft_message: '',
			channel_name: channel_name,
			conversation_user_info: _elm_lang$core$Maybe$Nothing,
			phoenix_socket: _fbonetti$elm_phoenix_socket$Phoenix_Socket$init(filled_socket_location),
			encrypted_options: encrypted_options,
			public_api_id: public_api_id,
			socket_location: filled_socket_location,
			current_user_name: _elm_lang$core$Maybe$Nothing,
			fetching_messages_scroll_pos: _elm_lang$core$Maybe$Just(0),
			debug_mode: debug_mode,
			moderation_window: _elm_lang$core$Maybe$Nothing
		};
	});
var _ResiliaDev$planga_chat_client$Models$isModerator = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1.conversation_user_info;
	if (_p2.ctor === 'Nothing') {
		return false;
	} else {
		return _elm_lang$core$Native_Utils.eq(_p2._0.role, 'moderator');
	}
};
var _ResiliaDev$planga_chat_client$Models$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
									...
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return {current_time: a, messages: b, oldest_timestamp: c, draft_message: d, phoenix_socket: e, socket_location: f, channel_name: g, conversation_user_info: h, encrypted_options: i, public_api_id: j, current_user_name: k, fetching_messages_scroll_pos: l, debug_mode: m, moderation_window: n};
													};
												};
											};
										};
...
var _ResiliaDev$planga_chat_client$Models$ChatMessage = F7(
	function (a, b, c, d, e, f, g) {
		return {uuid: a, author_name: b, author_role: c, author_uuid: d, content: e, sent_at: f, deleted_at: g};
	});
var _ResiliaDev$planga_chat_client$Models$chatMessageDecoder = A8(
	_elm_lang$core$Json_Decode$map7,
	_ResiliaDev$planga_chat_client$Models$ChatMessage,
	...
	A2(_elm_lang$core$Json_Decode$field, 'author_uuid', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'content', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'sent_at', _elm_lang$core$Json_Decode$string),
	A2(
		_elm_lang$core$Json_Decode$field,
		'deleted_at',
		_elm_lang$core$Json_Decode$nullable(_elm_lang$core$Json_Decode$string)));
var _ResiliaDev$planga_chat_client$Models$ConversationUserInfo = F3(
	function (a, b, c) {
		return {role: a, banned_until: b, user_id: c};
	});
var _ResiliaDev$planga_chat_client$Models$conversationUserInfoDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_ResiliaDev$planga_chat_client$Models$ConversationUserInfo,
	A2(
		_elm_lang$core$Json_Decode$field,
		'role',
		_elm_lang$core$Json_Decode$oneOf(
	...
	A2(
		...
		_elm_lang$core$Json_Decode$nullable(
			A2(
				_elm_lang$core$Json_Decode$map,
				function (posix_seconds) {
					return posix_seconds * _elm_lang$core$Time$second;
				},
				_elm_lang$core$Json_Decode$float))),
	A2(_elm_lang$core$Json_Decode$field, 'user_id', _elm_lang$core$Json_Decode$int));
var _ResiliaDev$planga_chat_client$Models$ModerationWindowState = function (a) {
	return {subject: a};
};
var _ResiliaDev$planga_chat_client$Models$Options = F4(
	function (a, b, c, d) {
		return {public_api_id: a, encrypted_options: b, socket_location: c, debug: d};
	});
var _ResiliaDev$planga_chat_client$Models$optionsDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_ResiliaDev$planga_chat_client$Models$Options,
	A2(_elm_lang$core$Json_Decode$field, 'public_api_id', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'encrypted_options', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'socket_location', _elm_lang$core$Json_Decode$string),
	_elm_lang$core$Json_Decode$oneOf(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Json_Decode$field, 'debug', _elm_lang$core$Json_Decode$bool),
			_1: {
				ctor: '::',
...
var _ResiliaDev$planga_chat_client$Models$BannedUntil = function (a) {
	return {ctor: 'BannedUntil', _0: a};
};
var _ResiliaDev$planga_chat_client$Models$NotBanned = {ctor: 'NotBanned'};
var _ResiliaDev$planga_chat_client$Models$banStatus = F2(
	function (current_time, _p3) {
		var _p4 = _p3;
		var _p5 = _p4.banned_until;
		if (_p5.ctor === 'Nothing') {
			return _ResiliaDev$planga_chat_client$Models$NotBanned;
		} else {
			var _p6 = _p5._0;
			return (_elm_lang$core$Native_Utils.cmp(_p6, current_time) < 0) ? _ResiliaDev$planga_chat_client$Models$NotBanned : _ResiliaDev$planga_chat_client$Models$BannedUntil(_p6);
		}
	});

var _ResiliaDev$planga_chat_client$Msgs$UnlockScrollHeight = {ctor: 'UnlockScrollHeight'};
var _ResiliaDev$planga_chat_client$Msgs$ScrollHeightCalculated = function (a) {
	return {ctor: 'ScrollHeightCalculated', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$ScrollTopChanged = {ctor: 'ScrollTopChanged'};
var _ResiliaDev$planga_chat_client$Msgs$HandleChatConnectionError = {ctor: 'HandleChatConnectionError'};
var _ResiliaDev$planga_chat_client$Msgs$CloseModerationWindow = {ctor: 'CloseModerationWindow'};
var _ResiliaDev$planga_chat_client$Msgs$OpenModerationWindow = function (a) {
	return {ctor: 'OpenModerationWindow', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$ChangedConversationUserInfo = function (a) {
	return {ctor: 'ChangedConversationUserInfo', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$ChangedYourConversationUserInfo = function (a) {
	return {ctor: 'ChangedYourConversationUserInfo', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$ChangedChatMessage = function (a) {
	return {ctor: 'ChangedChatMessage', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$UnbanUser = function (a) {
	return {ctor: 'UnbanUser', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$BanUser = F2(
	function (a, b) {
		return {ctor: 'BanUser', _0: a, _1: b};
	});
var _ResiliaDev$planga_chat_client$Msgs$ShowChatMessage = function (a) {
	return {ctor: 'ShowChatMessage', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$HideChatMessage = function (a) {
	return {ctor: 'HideChatMessage', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$ScrollMsg = function (a) {
	return {ctor: 'ScrollMsg', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$ChangeDraftMessage = function (a) {
	return {ctor: 'ChangeDraftMessage', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$MessagesSoFar = function (a) {
	return {ctor: 'MessagesSoFar', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$ReceiveMessage = function (a) {
	return {ctor: 'ReceiveMessage', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$SendMessage = function (a) {
	return {ctor: 'SendMessage', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$ShowLeftMessage = {ctor: 'ShowLeftMessage'};
var _ResiliaDev$planga_chat_client$Msgs$ShowErrorMessage = {ctor: 'ShowErrorMessage'};
var _ResiliaDev$planga_chat_client$Msgs$ShowJoinedMessage = function (a) {
	return {ctor: 'ShowJoinedMessage', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$PhoenixMsg = function (a) {
	return {ctor: 'PhoenixMsg', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$Debug = function (a) {
	return {ctor: 'Debug', _0: a};
};
var _ResiliaDev$planga_chat_client$Msgs$NoOp = {ctor: 'NoOp'};

var _ResiliaDev$planga_chat_client$Connection$setupConnection = function (model) {
	var channel = A2(
		_fbonetti$elm_phoenix_socket$Phoenix_Channel$onClose,
		_elm_lang$core$Basics$always(_ResiliaDev$planga_chat_client$Msgs$ShowLeftMessage),
		A2(
			_fbonetti$elm_phoenix_socket$Phoenix_Channel$onJoinError,
			_elm_lang$core$Basics$always(_ResiliaDev$planga_chat_client$Msgs$HandleChatConnectionError),
			A2(
				_fbonetti$elm_phoenix_socket$Phoenix_Channel$onError,
				_elm_lang$core$Basics$always(_ResiliaDev$planga_chat_client$Msgs$HandleChatConnectionError),
				A2(
					_fbonetti$elm_phoenix_socket$Phoenix_Channel$onJoin,
					_ResiliaDev$planga_chat_client$Msgs$ShowJoinedMessage,
					A2(
						_fbonetti$elm_phoenix_socket$Phoenix_Channel$withPayload,
						_elm_lang$core$Json_Encode$object(
							{ctor: '[]'}),
						_fbonetti$elm_phoenix_socket$Phoenix_Channel$init(model.channel_name))))));
	var _p0 = A2(
		...
		A4(
			...
			model.channel_name,
			_ResiliaDev$planga_chat_client$Msgs$ChangedYourConversationUserInfo,
			A4(
				_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
				'changed_conversation_user_info',
				model.channel_name,
				_ResiliaDev$planga_chat_client$Msgs$ChangedConversationUserInfo,
				A4(
					_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
					'messages_so_far',
					model.channel_name,
					_ResiliaDev$planga_chat_client$Msgs$MessagesSoFar,
					A4(
						_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
						'changed_message',
						model.channel_name,
						_ResiliaDev$planga_chat_client$Msgs$ChangedChatMessage,
						A4(
							_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
							'new_remote_message',
							model.channel_name,
							_ResiliaDev$planga_chat_client$Msgs$ReceiveMessage,
							function (val) {
								return model.debug_mode ? _fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug(val) : val;
							}(model.phoenix_socket)))))));
	var phoenix_socket = _p0._0;
	var phoenix_cmd = _p0._1;
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			model,
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Cmd$map, _ResiliaDev$planga_chat_client$Msgs$PhoenixMsg, phoenix_cmd),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$core$Task$attempt,
						function (_p1) {
							return _ResiliaDev$planga_chat_client$Msgs$Debug(
								_elm_lang$core$Basics$toString(_p1));
						},
						_elm_lang$dom$Dom_Scroll$toBottom('planga--chat-messages')),
					_1: {ctor: '[]'}
				}
			})
	};
...
var _ResiliaDev$planga_chat_client$Ports$persistToStorage = _elm_lang$core$Native_Platform.outgoingPort(
	'persistToStorage',
	function (v) {
		return v;
	});
var _ResiliaDev$planga_chat_client$Ports$fetchScrollPos = _elm_lang$core$Native_Platform.outgoingPort(
	'fetchScrollPos',
	function (v) {
		return v;
	});
var _ResiliaDev$planga_chat_client$Ports$scrollUpdate = _elm_lang$core$Native_Platform.incomingPort('scrollUpdate', _elm_lang$core$Json_Decode$value);
var _ResiliaDev$planga_chat_client$Ports$scrollToBottomPort = _elm_lang$core$Native_Platform.outgoingPort(
	'scrollToBottomPort',
	function (v) {
		return null;
	});
var _ResiliaDev$planga_chat_client$Ports$scrollToBottom = _ResiliaDev$planga_chat_client$Ports$scrollToBottomPort(
	{ctor: '_Tuple0'});
var _ResiliaDev$planga_chat_client$Ports$keepVScrollPosPort = _elm_lang$core$Native_Platform.outgoingPort(
	'keepVScrollPosPort',
	function (v) {
		return null;
	});
var _ResiliaDev$planga_chat_client$Ports$keepVScrollPos = _ResiliaDev$planga_chat_client$Ports$keepVScrollPosPort(
	{ctor: '_Tuple0'});
var _ResiliaDev$planga_chat_client$Ports$unlockVScrollPosPort = _elm_lang$core$Native_Platform.outgoingPort(
	'unlockVScrollPosPort',
	function (v) {
		return null;
	});
var _ResiliaDev$planga_chat_client$Ports$unlockVScrollPos = _ResiliaDev$planga_chat_client$Ports$unlockVScrollPosPort(
	{ctor: '_Tuple0'});
var _ResiliaDev$planga_chat_client$Ports$sendBrowserNotification = _elm_lang$core$Native_Platform.outgoingPort(
	'sendBrowserNotification',
	function (v) {
		return v;
	});

var _ResiliaDev$planga_chat_client$Native_Scroll = function() {
...
var _ResiliaDev$planga_chat_client$Scroll$toX = _ResiliaDev$planga_chat_client$Native_Scroll.setScrollLeft;
var _ResiliaDev$planga_chat_client$Scroll$x = _ResiliaDev$planga_chat_client$Native_Scroll.getScrollLeft;
var _ResiliaDev$planga_chat_client$Scroll$toRight = _ResiliaDev$planga_chat_client$Native_Scroll.toRight;
var _ResiliaDev$planga_chat_client$Scroll$toLeft = function (id) {
	return A2(_ResiliaDev$planga_chat_client$Scroll$toX, id, 0);
};
var _ResiliaDev$planga_chat_client$Scroll$toBottomY = _ResiliaDev$planga_chat_client$Native_Scroll.setScrollBottom;
var _ResiliaDev$planga_chat_client$Scroll$toY = _ResiliaDev$planga_chat_client$Native_Scroll.setScrollTop;
var _ResiliaDev$planga_chat_client$Scroll$bottomY = _ResiliaDev$planga_chat_client$Native_Scroll.getScrollBottom;
var _ResiliaDev$planga_chat_client$Scroll$y = _ResiliaDev$planga_chat_client$Native_Scroll.getScrollTop;
var _ResiliaDev$planga_chat_client$Scroll$toBottom = _ResiliaDev$planga_chat_client$Native_Scroll.toBottom;
var _ResiliaDev$planga_chat_client$Scroll$toTop = function (id) {
	return A2(_ResiliaDev$planga_chat_client$Scroll$toY, id, 0);
};
...
var _ResiliaDev$planga_chat_client$Update$minimumMaybe = F2(
	function (x, y) {
		...
		if (_p0._0.ctor === 'Nothing') {
			...
			if (_p0._1.ctor === 'Nothing') {
				...
				return _elm_lang$core$Maybe$Just(
					A2(_elm_lang$core$Basics$min, _p0._0._0, _p0._1._0));
			}
		}
	});
var _ResiliaDev$planga_chat_client$Update$fetchOldMessages = F2(
	function (model, scroll_bottom) {
		var _p1 = model.oldest_timestamp;
		if (_p1.ctor === 'Nothing') {
			...
			var push_data = A2(
				...
				_elm_lang$core$Basics$always(
					_ResiliaDev$planga_chat_client$Msgs$ScrollMsg(_ResiliaDev$planga_chat_client$Msgs$UnlockScrollHeight)),
				A2(
					_fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload,
					payload,
					A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init, 'load_old_messages', model.channel_name)));
			var _p2 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, push_data, model.phoenix_socket);
			var phoenix_socket = _p2._0;
			var phoenix_command = _p2._1;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						phoenix_socket: phoenix_socket,
						fetching_messages_scroll_pos: _elm_lang$core$Maybe$Just(scroll_bottom)
					}),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _ResiliaDev$planga_chat_client$Msgs$PhoenixMsg, phoenix_command)
			};
		}
	});
var _ResiliaDev$planga_chat_client$Update$updateScrollMsg = F2(
	function (model, scroll_msg) {
		var _p3 = scroll_msg;
		switch (_p3.ctor) {
			case 'ScrollTopChanged':
				var fetch_scroll_pos = A2(
					_elm_lang$core$Task$attempt,
					_ResiliaDev$planga_chat_client$Msgs$ScrollHeightCalculated,
					A3(
						_elm_lang$core$Task$map2,
						F2(
							function (top, bottom) {
								return {ctor: '_Tuple2', _0: top, _1: bottom};
							}),
						_ResiliaDev$planga_chat_client$Scroll$y(
							_ResiliaDev$planga_chat_client$Models$uniqueMessagesContainerId(model)),
						_ResiliaDev$planga_chat_client$Scroll$bottomY(
							_ResiliaDev$planga_chat_client$Models$uniqueMessagesContainerId(model))));
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$core$Platform_Cmd$map, _ResiliaDev$planga_chat_client$Msgs$ScrollMsg, fetch_scroll_pos)
				};
			case 'ScrollHeightCalculated':
				var _p4 = _p3._0;
				if (_p4.ctor === 'Err') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					return ((_elm_lang$core$Native_Utils.cmp(_p4._0._0, 200) < 0) && _elm_community$maybe_extra$Maybe_Extra$isNothing(model.fetching_messages_scroll_pos)) ? A2(_ResiliaDev$planga_chat_client$Update$fetchOldMessages, model, _p4._0._1) : {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			default:
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{fetching_messages_scroll_pos: _elm_lang$core$Maybe$Nothing}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _ResiliaDev$planga_chat_client$Update$update = F2(
	function (msg, model) {
		var _p5 = msg;
		switch (_p5.ctor) {
			case 'NoOp':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Debug':
				var _p6 = A2(_elm_lang$core$Debug$log, 'Debug', _p5._0);
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Tick':
				return {
					ctor: '_Tuple2',
			...
			case 'PhoenixMsg':
				var _p7 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$update, _p5._0, model.phoenix_socket);
				var phoenix_socket = _p7._0;
				var phoenix_command = _p7._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'ShowJoinedMessage':
				var _p8 = A2(
					...
					A2(_elm_lang$core$Json_Decode$field, 'current_user_name', _elm_lang$core$Json_Decode$string),
					_p5._0);
				if (_p8.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								current_user_name: _elm_lang$core$Maybe$Just(_p8._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'ShowErrorMessage':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'HandleChatConnectionError':
				var _p9 = _elm_lang$core$Debug$log('ConnectionError');
				return _ResiliaDev$planga_chat_client$Connection$setupConnection(model);
			case 'SendMessage':
				var constructed_request = _elm_lang$core$Json_Encode$object(
					{
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
				...
				var push_data = A2(
					_fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload,
					constructed_request,
					A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init, 'new_message', model.channel_name));
				var _p10 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, push_data, model.phoenix_socket);
				var phoenix_socket = _p10._0;
				var phoenix_command = _p10._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{phoenix_socket: phoenix_socket, draft_message: ''}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _ResiliaDev$planga_chat_client$Msgs$PhoenixMsg, phoenix_command)
				};
			case 'ReceiveMessage':
				var _p11 = A2(_elm_lang$core$Json_Decode$decodeValue, _ResiliaDev$planga_chat_client$Models$chatMessageDecoder, _p5._0);
				if (_p11.ctor === 'Err') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var _p12 = _p11._0;
					var oldest_timestamp = A2(
						_ResiliaDev$planga_chat_client$Update$minimumMaybe,
						_elm_lang$core$Maybe$Just(_p12.sent_at),
						model.oldest_timestamp);
					var updated_messages = A3(_elm_lang$core$Dict$insert, _p12.uuid, _p12, model.messages);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{messages: updated_messages, oldest_timestamp: oldest_timestamp}),
						_1: _elm_lang$core$Platform_Cmd$batch(
							{
								ctor: '::',
								_0: _ResiliaDev$planga_chat_client$Ports$scrollToBottom,
								_1: {
									ctor: '::',
									_0: _ResiliaDev$planga_chat_client$Ports$sendBrowserNotification(
										A2(
											_elm_lang$core$Basics_ops['++'],
											_p12.author_name,
											A2(_elm_lang$core$Basics_ops['++'], ': ', _p12.content))),
									_1: {ctor: '[]'}
								}
							})
					};
				}
			case 'ChangedChatMessage':
				var _p13 = A2(_elm_lang$core$Json_Decode$decodeValue, _ResiliaDev$planga_chat_client$Models$chatMessageDecoder, _p5._0);
				if (_p13.ctor === 'Err') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var _p14 = _p13._0;
					var updated_messages = A3(_elm_lang$core$Dict$insert, _p14.uuid, _p14, model.messages);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
			...
			case 'ChangedYourConversationUserInfo':
				var _p15 = A2(_elm_lang$core$Json_Decode$decodeValue, _ResiliaDev$planga_chat_client$Models$conversationUserInfoDecoder, _p5._0);
				if (_p15.ctor === 'Err') {
					var _p16 = A2(_elm_lang$core$Debug$log, 'ChangedYourConversationUserInfo error', _p15._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var _p18 = _p15._0;
					var _p17 = A2(_elm_lang$core$Debug$log, 'ChangedYourConversationUserInfo', _p18);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								conversation_user_info: _elm_lang$core$Maybe$Just(_p18)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'ChangedConversationUserInfo':
				var _p19 = A2(_elm_lang$core$Json_Decode$decodeValue, _ResiliaDev$planga_chat_client$Models$conversationUserInfoDecoder, _p5._0);
				if (_p19.ctor === 'Err') {
					var _p20 = A2(_elm_lang$core$Debug$log, 'ChangedConversationUserInfo error', _p19._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var _p21 = A2(_elm_lang$core$Debug$log, 'ChangedConversationUserInfo', _p19._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'MessagesSoFar':
				var fix_scroll_pos = function () {
					var _p22 = model.fetching_messages_scroll_pos;
					if (_p22.ctor === 'Nothing') {
						return _elm_lang$core$Platform_Cmd$none;
					} else {
						return _ResiliaDev$planga_chat_client$Ports$keepVScrollPos;
					}
				}();
				var messagesDecoder = A2(
					_elm_lang$core$Json_Decode$field,
					'messages',
					_elm_lang$core$Json_Decode$list(_ResiliaDev$planga_chat_client$Models$chatMessageDecoder));
				var _p23 = A2(_elm_lang$core$Json_Decode$decodeValue, messagesDecoder, _p5._0);
				if (_p23.ctor === 'Ok') {
					var _p24 = _p23._0;
					var oldest_timestamp = A2(
						_ResiliaDev$planga_chat_client$Update$minimumMaybe,
						_elm_lang$core$List$minimum(
							A2(
								...
								_p24)),
						model.oldest_timestamp);
					var new_messages = _elm_lang$core$Dict$fromList(
						A2(
							_elm_lang$core$List$map,
							function (message) {
								return {ctor: '_Tuple2', _0: message.uuid, _1: message};
							},
							_p24));
					var updated_messages = A2(_elm_lang$core$Dict$union, new_messages, model.messages);
					return _elm_lang$core$Native_Utils.eq(
						_elm_lang$core$List$length(_p24),
						0) ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none} : {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{messages: updated_messages, oldest_timestamp: oldest_timestamp, fetching_messages_scroll_pos: _elm_lang$core$Maybe$Nothing}),
						_1: fix_scroll_pos
					};
				} else {
					var _p25 = A2(_elm_lang$core$Debug$log, 'MessagesSoFar error', _p23._0);
					return {ctor: '_Tuple2', _0: model, _1: fix_scroll_pos};
				}
			case 'ChangeDraftMessage':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{draft_message: _p5._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ScrollMsg':
				return A2(_ResiliaDev$planga_chat_client$Update$updateScrollMsg, model, _p5._0);
			case 'HideChatMessage':
				...
				var push_data = A2(
					_fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload,
					constructed_request,
					A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init, 'hide_message', model.channel_name));
				var _p26 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, push_data, model.phoenix_socket);
				var phoenix_socket = _p26._0;
				var phoenix_command = _p26._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'ShowChatMessage':
				...
				var push_data = A2(
					_fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload,
					constructed_request,
					A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init, 'show_message', model.channel_name));
				var _p27 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, push_data, model.phoenix_socket);
				var phoenix_socket = _p27._0;
				var phoenix_command = _p27._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'BanUser':
				...
				var push_data = A2(
					_fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload,
					constructed_request,
					A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init, 'ban_user', model.channel_name));
				var _p28 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, push_data, model.phoenix_socket);
				var phoenix_socket = _p28._0;
				var phoenix_command = _p28._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'UnbanUser':
				...
				var push_data = A2(
					_fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload,
					constructed_request,
					A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init, 'unban_user', model.channel_name));
				var _p29 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, push_data, model.phoenix_socket);
				var phoenix_socket = _p29._0;
				var phoenix_command = _p29._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'OpenModerationWindow':
				return _ResiliaDev$planga_chat_client$Models$isModerator(model) ? A2(
					...
					'OpenModerationWindow',
					{
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								moderation_window: _elm_lang$core$Maybe$Just(
									{subject: _p5._0})
							}),
						_1: _elm_lang$core$Platform_Cmd$none
...
var _ResiliaDev$planga_chat_client$View$moderationWindow = function (model) {
	var list_item = function (_p0) {
		var _p1 = _p0;
		return {
			ctor: '::',
			_0: A2(
	...
	var info_list = function (subject) {
		return A2(
			_elm_lang$core$List$concatMap,
			list_item,
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'User', _1: subject.author_name},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'Message', _1: subject.content},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'Status',
							_1: _elm_lang$core$Native_Utils.eq(subject.deleted_at, _elm_lang$core$Maybe$Nothing) ? 'Visible' : 'Hidden'
						},
						_1: {ctor: '[]'}
					}
				}
	...
	var _p2 = model.moderation_window;
	if (_p2.ctor === 'Nothing') {
		return _elm_lang$html$Html$text('');
	} else {
		var _p3 = _p2._0.subject;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('planga--moderation-window'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Message Actions'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$button,
													{
														...
														_0: _elm_lang$html$Html_Events$onClick(
															_ResiliaDev$planga_chat_client$Msgs$HideChatMessage(_p3.uuid)),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('hide this message'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$button,
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(
																_ResiliaDev$planga_chat_client$Msgs$ShowChatMessage(_p3.uuid)),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('show this message'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Ban User'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html$button,
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onClick(
																		A2(_ResiliaDev$planga_chat_client$Msgs$BanUser, _p3.author_uuid, 1)),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
															...
															_1: {
																...
																_0: A2(
																	_elm_lang$html$Html$button,
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Events$onClick(
																			A2(_ResiliaDev$planga_chat_client$Msgs$BanUser, _p3.author_uuid, 5)),
																		_1: {ctor: '[]'}
																	},
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('5 minues'),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		_elm_lang$html$Html$button,
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onClick(
																				A2(_ResiliaDev$planga_chat_client$Msgs$BanUser, _p3.author_uuid, 15)),
																			_1: {ctor: '[]'}
																		},
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('15 minutes'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			_elm_lang$html$Html$button,
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html_Events$onClick(
																					A2(_ResiliaDev$planga_chat_client$Msgs$BanUser, _p3.author_uuid, 1 * 60)),
																				_1: {ctor: '[]'}
																			},
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('1 hour'),
																				_1: {ctor: '[]'}
																			}),
																		_1: {
																			ctor: '::',
																			_0: A2(
																				_elm_lang$html$Html$button,
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html_Events$onClick(
																						A2(_ResiliaDev$planga_chat_client$Msgs$BanUser, _p3.author_uuid, (1 * 60) * 24)),
																					_1: {ctor: '[]'}
																				},
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html$text('1 day'),
																					_1: {ctor: '[]'}
																				}),
																			_1: {
																				ctor: '::',
																				_0: A2(
																					_elm_lang$html$Html$button,
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html_Events$onClick(
																							A2(_ResiliaDev$planga_chat_client$Msgs$BanUser, _p3.author_uuid, (((1 * 60) * 24) * 256) * 1000)),
																						_1: {ctor: '[]'}
																					},
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html$text('indefinitely'),
																						_1: {ctor: '[]'}
																					}),
																				_1: {
																					ctor: '::',
																					_0: A2(
																						_elm_lang$html$Html$button,
																						{
																							ctor: '::',
																							_0: _elm_lang$html$Html_Events$onClick(
																								_ResiliaDev$planga_chat_client$Msgs$UnbanUser(_p3.author_uuid)),
																							_1: {ctor: '[]'}
																						},
																						{
																							ctor: '::',
																							_0: _elm_lang$html$Html$text('unban'),
																							_1: {ctor: '[]'}
																						}),
																					_1: {ctor: '[]'}
																				}
...
var _ResiliaDev$planga_chat_client$View$newMessageForm = function (model) {
	var ban_status = A2(
		_elm_lang$core$Maybe$withDefault,
		_ResiliaDev$planga_chat_client$Models$NotBanned,
		A2(
			_elm_lang$core$Maybe$map,
			_ResiliaDev$planga_chat_client$Models$banStatus(model.current_time),
			model.conversation_user_info));
	var is_banned = !_elm_lang$core$Native_Utils.eq(ban_status, _ResiliaDev$planga_chat_client$Models$NotBanned);
	var placeholder_value = function () {
		var _p4 = {ctor: '_Tuple2', _0: model.conversation_user_info, _1: model.current_user_name};
		if ((_p4._0.ctor === 'Just') && (_p4._1.ctor === 'Just')) {
			var _p5 = ban_status;
			if (_p5.ctor === 'BannedUntil') {
				return {
					disabled: true,
					placeholder: A2(
						_elm_lang$core$Basics_ops['++'],
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_p5._0 - model.current_time),
							' more milliseconds'))
				};
			} else {
				return {
					disabled: false,
					placeholder: A2(_elm_lang$core$Basics_ops['++'], _p4._1._0, ': Type your message here')
				};
			}
		} else {
			return {disabled: true, placeholder: 'Not connected to Planga Chat'};
		}
	}();
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('planga--new-message-form'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onSubmit(
					_ResiliaDev$planga_chat_client$Msgs$SendMessage(model.draft_message)),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('planga--new-message-field-wrapper'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$maxlength(4096),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$placeholder(placeholder_value.placeholder),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$name('planga-new-message-field'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('planga--new-message-field'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_ResiliaDev$planga_chat_client$Msgs$ChangeDraftMessage),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(model.draft_message),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$disabled(placeholder_value.disabled),
													_1: {ctor: '[]'}
												}
											}
										}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('planga--new-message-submit-button'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _ResiliaDev$planga_chat_client$View$scrollHeight = function (height) {
	return A2(
		_elm_lang$html$Html_Attributes$property,
		'scrollTop',
		_elm_lang$core$Json_Encode$int(height));
};
var _ResiliaDev$planga_chat_client$View$onScrollFetchScrollInfo = A2(
	_elm_lang$html$Html_Events$on,
	'scroll',
	A2(
		_elm_lang$core$Json_Decode$map,
		_elm_lang$core$Basics$always(
			_ResiliaDev$planga_chat_client$Msgs$ScrollMsg(_ResiliaDev$planga_chat_client$Msgs$ScrollTopChanged)),
		_elm_lang$core$Json_Decode$value));
var _ResiliaDev$planga_chat_client$View$checkbox = F2(
...
var _ResiliaDev$planga_chat_client$View$onRightClick = function (message) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'contextmenu',
...
var _ResiliaDev$planga_chat_client$View$data = F2(
	function (name, val) {
		return A2(
			_elm_lang$html$Html_Attributes$attribute,
...
var _ResiliaDev$planga_chat_client$View$message = F3(
	function (current_user_name, is_moderator, message) {
		var options_button = is_moderator ? A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('planga--chat-message-options'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$span,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_ResiliaDev$planga_chat_client$Msgs$OpenModerationWindow(message)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
		...
		var message_content = is_deleted ? A2(
			_elm_lang$html$Html$span,
			{
				...
				_0: _elm_lang$html$Html_Attributes$title(
					A2(_elm_lang$core$Basics_ops['++'], 'Original message: ', message.content)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('This message was deleted'),
				_1: {ctor: '[]'}
			}) : _elm_lang$html$Html$text(
			_marcosh$elm_html_to_unicode$ElmEscapeHtml$unescape(message.content));
		var is_current_user = function () {
			var _p6 = A2(
				_elm_lang$core$Maybe$map,
				function (val) {
					return _elm_lang$core$Native_Utils.eq(val, message.author_name);
				},
				current_user_name);
		...
		return (is_deleted && (!is_moderator)) ? _elm_lang$html$Html$text('') : A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(message_class),
				_1: {
					ctor: '::',
					_0: A2(_ResiliaDev$planga_chat_client$View$data, 'chat-message--sent-at', message.sent_at),
					_1: {
						ctor: '::',
						_0: A2(_ResiliaDev$planga_chat_client$View$data, 'chat-message--uuid', message.uuid),
						_1: {
							ctor: '::',
							_0: A2(_ResiliaDev$planga_chat_client$View$data, 'chat-message--author-role', message.author_role),
							_1: {
								ctor: '::',
								_0: A2(_ResiliaDev$planga_chat_client$View$data, 'chat-message--author-name', message.author_name),
								_1: {
									ctor: '::',
									_0: _ResiliaDev$planga_chat_client$View$onRightClick(
										_ResiliaDev$planga_chat_client$Msgs$OpenModerationWindow(message)),
									_1: {ctor: '[]'}
								}
							}
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('planga--chat-message-sent-at-wrapper'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('planga--chat-message-sent-at'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$title(message.sent_at),
										_1: {ctor: '[]'}
									}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(message.sent_at),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('planga--chat-author-wrapper'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('planga--chat-author-name'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(message.author_name),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('planga--chat-message-separator'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('planga--chat-message-content'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _ResiliaDev$planga_chat_client$View$messages = function (model) {
	var is_moderator = _ResiliaDev$planga_chat_client$Models$isModerator(model);
	var message_list = A2(
	...
	var messages_html = A2(
		_elm_lang$core$List$map,
		A2(_ResiliaDev$planga_chat_client$View$message, model.current_user_name, is_moderator),
		message_list);
	return A2(
		_elm_lang$html$Html$dl,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('planga--chat-messages'),
			_1: {
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _ResiliaDev$planga_chat_client$View$onScrollFetchScrollInfo,
					_1: {ctor: '[]'}
				}
			}
		},
...
var _ResiliaDev$planga_chat_client$View$container = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('planga--chat-container'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _ResiliaDev$planga_chat_client$View$messages(model),
			_1: {
				ctor: '::',
				_0: _ResiliaDev$planga_chat_client$View$newMessageForm(model),
				_1: {
					ctor: '::',
					_0: _ResiliaDev$planga_chat_client$View$moderationWindow(model),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _ResiliaDev$planga_chat_client$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _ResiliaDev$planga_chat_client$View$container(model),
			_1: {ctor: '[]'}
		});
};

var _ResiliaDev$planga_chat_client$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _ResiliaDev$planga_chat_client$Msgs$Tick),
			_1: {
				ctor: '::',
				_0: A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.phoenix_socket, _ResiliaDev$planga_chat_client$Msgs$PhoenixMsg),
				_1: {ctor: '[]'}
			}
		});
};
var _ResiliaDev$planga_chat_client$Main$init = function (flags) {
	var options = function () {
		var _p0 = A2(_elm_lang$core$Json_Decode$decodeValue, _ResiliaDev$planga_chat_client$Models$optionsDecoder, flags);
		if (_p0.ctor === 'Ok') {
			return A2(_elm_lang$core$Debug$log, 'Options parsed!', _p0._0);
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 24, column: 13},
					end: {line: 29, column: 90}
				},
				_p0)(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'Could not start Planga application:',
					_elm_lang$core$Basics$toString(_p0._0)));
		}
	}();
	var model = A4(
		_ResiliaDev$planga_chat_client$Models$initialModel,
		options.public_api_id,
		options.encrypted_options,
		A2(_elm_lang$core$Basics_ops['++'], options.socket_location, '/websocket'),
		options.debug);
	return _ResiliaDev$planga_chat_client$Connection$setupConnection(model);
};
var _ResiliaDev$planga_chat_client$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _ResiliaDev$planga_chat_client$Main$init, view: _ResiliaDev$planga_chat_client$View$view, update: _ResiliaDev$planga_chat_client$Update$update, subscriptions: _ResiliaDev$planga_chat_client$Main$subscriptions})(_elm_lang$core$Json_Decode$value);

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _ResiliaDev$planga_chat_client$Main$main !== 'undefined') {
    _ResiliaDev$planga_chat_client$Main$main(Elm['Main'], 'Main', undefined);
}
