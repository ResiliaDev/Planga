defmodule Planga.Chat.Converse do
  def try_create_message(message, %{
    ...
    case Planga.Chat.Message.valid_message?(message) do
      false ->
      ...
      true ->
        ...
        case Planga.Chat.ConversationUser.banned?(conversation_user_info) do
          true ->
          ...
          false ->
            ...
            message =
              Planga.Chat.Converse.Persistence.create_message(
                app_id,
                remote_conversation_id,
                user_id,
                message,
