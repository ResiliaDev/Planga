defmodule Planga.Chat.Moderation.Persistence do
  ...
  defdelegate update_message(conversation_id, message_uuid, update_function),
    to: persistence_implementation

  defdelegate update_conversation_user(conversation_id, user_id, update_function),
    to: persistence_implementation

  defdelegate find_or_create_conversation_by_remote_id!(app_id, remote_id),
    to: Planga.Chat.Converse.Persistence
