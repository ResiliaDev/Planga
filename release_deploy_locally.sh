...
sudo rsync -hvrPt --ignore-existing _build/prod/rel/planga/releases/${relnum}/planga.tar.gz /var/www/plange/releases/${relnum}/
echo "Done Copying!"
echo "Attempting to upgrade application through SSH..."
sudo /var/www/planga/bin/plange upgrade ${relnum}
echo "Done!"
