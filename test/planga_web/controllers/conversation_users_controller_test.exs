defmodule PlangaWeb.ConversationUsersControllerTest do
  ...
  describe "create conversation_users" do
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      conn =
        post(conn, conversation_users_path(conn, :create), conversation_users: @invalid_attrs)
  ...
  describe "update conversation_users" do
    ...
    test "renders conversation_users when data is valid", %{
      conn: conn,
      conversation_users: %ConversationUsers{id: id} = conversation_users
    } do
      conn =
        put(
          conn,
          conversation_users_path(conn, :update, conversation_users),
          conversation_users: @update_attrs
        )
    ...
    test "renders errors when data is invalid", %{
      ...
      conn =
        put(
          conn,
          conversation_users_path(conn, :update, conversation_users),
          conversation_users: @invalid_attrs
        )
  ...
  describe "delete conversation_users" do
    ...
    test "deletes chosen conversation_users", %{
      conn: conn,
      conversation_users: conversation_users
    } do
